(function () {
  const appVersion = "20260729-category-order-r22";
  ...
  const retiredProductIds = [
    ...
    "i-love-laos-coconut-butterfly-pea",
    "elephant-mango-passion",
    "elephant-strawberry-milk",
    "elephant-japanese-melon",
    "elephant-coconut-butterfly-pea",
    "frangipani-mango-passion",
    "frangipani-strawberry-milk",
    "frangipani-japanese-melon",
    "frangipani-coconut-butterfly-pea",
    "lychee-rose-soda",
    "patuxai-sunset-soda",
  ...
  function initPwa() {
    ...
    if ("serviceWorker" in window.navigator && window.location.protocol.indexOf("http") === 0) {
      window.addEventListener("load", () => {
        ...
        window.navigator.serviceWorker.register(`sw.js?v=${appVersion}`, { updateViaCache: "none" })
