(function () {
  const appVersion = "20260704-product-management";
  const productCatalog = [
    ...
    { id: "i-love-laos-mango-passion", name: "I Love Laos - Mango & Passion Fruit", category: "Patuxai Pops", shape: "I Love Laos", flavor: "Mango & Passion Fruit", shape_order: 2, flavor_order: 1, price: 55000, stock: 0, sold_out: true, is_active: true, image_path: "assets/shapes/shape-i-love-laos.png", note: "芒果百香果", sort_order: 5 },
    { id: "i-love-laos-strawberry-milk", name: "I Love Laos - Strawberry Milk", category: "Patuxai Pops", shape: "I Love Laos", flavor: "Strawberry Milk", shape_order: 2, flavor_order: 2, price: 55000, stock: 0, sold_out: true, is_active: true, image_path: "assets/shapes/shape-i-love-laos.png", note: "草莓牛奶", sort_order: 6 },
    { id: "i-love-laos-japanese-melon", name: "I Love Laos - Japanese Melon", category: "Patuxai Pops", shape: "I Love Laos", flavor: "Japanese Melon", shape_order: 2, flavor_order: 3, price: 55000, stock: 0, sold_out: true, is_active: true, image_path: "assets/shapes/shape-i-love-laos.png", note: "日本蜜瓜", sort_order: 7 },
    { id: "i-love-laos-coconut-butterfly-pea", name: "I Love Laos - Coconut + Butterfly Pea", category: "Patuxai Pops", shape: "I Love Laos", flavor: "Coconut + Butterfly Pea", shape_order: 2, flavor_order: 4, price: 55000, stock: 0, sold_out: true, is_active: true, image_path: "assets/shapes/shape-i-love-laos.png", note: "椰子蝶豆花", sort_order: 8 },
    { id: "elephant-mango-passion", name: "Elephant - Mango & Passion Fruit", category: "Patuxai Pops", shape: "Elephant", flavor: "Mango & Passion Fruit", shape_order: 3, flavor_order: 1, price: 55000, stock: 0, sold_out: true, is_active: true, image_path: "assets/shapes/shape-elephant.png", note: "芒果百香果", sort_order: 9 },
    { id: "elephant-strawberry-milk", name: "Elephant - Strawberry Milk", category: "Patuxai Pops", shape: "Elephant", flavor: "Strawberry Milk", shape_order: 3, flavor_order: 2, price: 55000, stock: 0, sold_out: true, is_active: true, image_path: "assets/shapes/shape-elephant.png", note: "草莓牛奶", sort_order: 10 },
    { id: "elephant-japanese-melon", name: "Elephant - Japanese Melon", category: "Patuxai Pops", shape: "Elephant", flavor: "Japanese Melon", shape_order: 3, flavor_order: 3, price: 55000, stock: 0, sold_out: true, is_active: true, image_path: "assets/shapes/shape-elephant.png", note: "日本蜜瓜", sort_order: 11 },
    { id: "elephant-coconut-butterfly-pea", name: "Elephant - Coconut + Butterfly Pea", category: "Patuxai Pops", shape: "Elephant", flavor: "Coconut + Butterfly Pea", shape_order: 3, flavor_order: 4, price: 55000, stock: 0, sold_out: true, is_active: true, image_path: "assets/shapes/shape-elephant.png", note: "椰子蝶豆花", sort_order: 12 },
    { id: "frangipani-mango-passion", name: "Frangipani Flower - Mango & Passion Fruit", category: "Patuxai Pops", shape: "Frangipani Flower", flavor: "Mango & Passion Fruit", shape_order: 4, flavor_order: 1, price: 55000, stock: 0, sold_out: true, is_active: true, image_path: "assets/shapes/shape-frangipani.png", note: "芒果百香果", sort_order: 13 },
    { id: "frangipani-strawberry-milk", name: "Frangipani Flower - Strawberry Milk", category: "Patuxai Pops", shape: "Frangipani Flower", flavor: "Strawberry Milk", shape_order: 4, flavor_order: 2, price: 55000, stock: 0, sold_out: true, is_active: true, image_path: "assets/shapes/shape-frangipani.png", note: "草莓牛奶", sort_order: 14 },
    { id: "frangipani-japanese-melon", name: "Frangipani Flower - Japanese Melon", category: "Patuxai Pops", shape: "Frangipani Flower", flavor: "Japanese Melon", shape_order: 4, flavor_order: 3, price: 55000, stock: 0, sold_out: true, is_active: true, image_path: "assets/shapes/shape-frangipani.png", note: "日本蜜瓜", sort_order: 15 },
